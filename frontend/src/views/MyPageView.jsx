        ...
        <div className="bg-slate-900 p-10 text-white">
          ...
          <form onSubmit={handleSubmit} className="p-10 space-y-8">
            ...
            <div className="rounded-3xl border border-red-100 bg-red-50/60 p-6 space-y-4">
              <div>
                <h3 className="text-base font-black text-red-600">회원 탈퇴</h3>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-14 pr-5 py-4 bg-white border border-red-200 rounded-2xl text-sm font-bold outline-none focus:ring-2 focus:ring-red-400"
                  />
                </div>
              </div>
      ...
      {deleteConfirmOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/55 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-[2rem] bg-white p-8 shadow-2xl">
            ...
            <h3 className="text-center text-2xl font-black tracking-tight text-slate-900">
              회원 탈퇴 확인
            </h3>
            ...
            <div className="mt-6 flex gap-3">
              <button
                ...
                disabled={deleting}
                className="flex-1 rounded-2xl bg-slate-100 px-4 py-3 text-sm font-black text-slate-500 transition hover:bg-slate-200"
              >
                취소
              </button>
              <button
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/55 px-4 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-[2rem] bg-white p-8 shadow-2xl">
            ...
            <button
              ...
              className="mt-6 w-full rounded-2xl bg-slate-900 px-4 py-3 text-sm font-black text-white transition hover:bg-slate-800"
            >
              확인
            </button>
          </div>
